...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">${product.prodCount } 개</td>
	</tr>
				...
				<c:set var="images" value="${fn:split(product.fileName , '/') }" />	
					<td height="26">
						<c:forEach var="image" items="${images }" >
							<img src="C:/workspace/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/z.10.Model2MVCShop(Ajax)/images/uploadFiles/${image}" width="100" height="100" />
						</c:forEach>
					</td>
				</tr>
			</table>
