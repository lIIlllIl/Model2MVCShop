		...
		$.ajax(
				{
					...
					success : function( JSONData, status ) {
						var displayValue = 	"<h4>" + 
											...
											"상품등록일자 : " + JSONData.product.regDate + "<br/>" + 
											"<br/><br/>" + "<span name='saw'>>>상품수정<<</span></h4>"
				
						$("h4").remove();
						$("#"+prodNo+"").html(displayValue);
						
						$("span[name='saw']").on("click", function() {
							self.location = "/product/getProduct?prodNo="+JSONData.product.prodNo+"&menu=manage";
						})						
					}
				}
		)
		...
		<td align="right">
			<select name="searchCondition" class="ct_input_g" style="width:150px" >
				...
				<option value="4" ${ ! empty search.searchCondition && search.searchCondition == 4 ? "selected" : "" }>상품가격-범위</option>
					...
					<input 	type="text" name="searchKeyword" id="searchKeyword" title="대소문자를 구별합니다." 
