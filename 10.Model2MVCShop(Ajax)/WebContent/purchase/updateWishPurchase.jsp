...
<form name="updateWishPurchase" method="post" action="/purchase/updateWishPurchase?tranNo=${purchase.tranNo }">
	...
	<tr>
		...
		<td background="../images/ct_ttl_img02.gif" width="100%" style="padding-left: 10px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="93%" class="ct_ttl01">장바구니 수정</td>
...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01"><fmt:formatNumber value="${purchase.purchaseProd.price }" type="currency" /></td>
		<input type="hidden" name="buyerId" value="user02">
	</tr>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input 	type="text" name="tranCount" 	class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20" value="${purchase.tranCount }" />
		</td>
	</tr>
		...
		<td width="200" class="ct_write01">
			<input type="text" readonly="readonly" name="divyDate" class="ct_input_g" 
				...
				<img 	src="../images/ct_icon_date.gif" width="15" height="15"	
							onclick="show_calendar('document.updateWishPurchase.divyDate', document.updateWishPurchase.divyDate.value)"/>
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
