...
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
			$("a[href='#']:contains('배송하기')").on("click", function(){
	 	 						...
	 	 						success : function( JSONData, status ) {
	 	 							...
	 	 							for ( count = 0; count < JSONData.list.length; count++) { 
										...
										var image = '';
	 	 								...
	 	 								display += "<br/>";
	 	 								display += "<h4><p><span class='glyphicon glyphicon-asterisk'></span>&nbsp;&nbsp;&nbsp; 구매아이디 : " + JSONData.list[count].buyer.userId + "</p></h4>"; 
	 	 								display += "<h4><p><span class='glyphicon glyphicon-asterisk'></span>&nbsp;&nbsp;&nbsp; 구매자이름 : " + JSONData.list[count].receiverName + "</p></h4>";
	 	 								
	 	 								var receiverPhone = '';
	 	 								
	 	 								if ( JSONData.list[count].receiverPhone == null ) {
	 	 									receiverPhone = '입력하지 않았습니다.';
	 	 								}
	 	 								else {
	 	 									receiverPhone = JSONData.list[count].receiverPhone;
	 	 								}
	 	 								
	 	 								display += "<h4><p><span class='glyphicon glyphicon-asterisk'></span>&nbsp;&nbsp;&nbsp; 구매자이름 : " + receiverPhone + "</p></h4>";
	 	 								
	 	 								var tranPrice = JSONData.list[count].purchaseProd.price * JSONData.list[count].tranCount;
	 	 								
	 	 								display += "<h4><p><span class='glyphicon glyphicon-asterisk'></span>&nbsp;&nbsp;&nbsp; 결제금액 : " + tranPrice.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + " 개</p></h4>";
	 	 						//		display += "<h4><p><span class='glyphicon glyphicon-shopping-cart'></span>&nbsp;&nbsp;&nbsp; 결제금액 : " + (JSONData.list[count].purchaseProd.price * JSONData.list[count].tranCount) + "</p></h4>";
	 									...
	 									display += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
	 	 								...
	 	 								if (tranCode == '1') {
		 	 								...
		 	 								display += "<input type='hidden' id='tranNo' name='tranNo' value='"+JSONData.list[count].tranNo+"'/>&nbsp;&nbsp;&nbsp; 배송하기 &raquo;</a>";
	 	 								}
	 	 								else {
	 	 									display += "&nbsp;";
	 	 								}
...
<body>
	...
	<div class="page-header text-info">
		...
		<br/>
		<h6 class="text-muted">현재 판매된 상품들을 <strong class="text-danger">확인 </strong>할 수 있습니다.</h6>
	</div>
			...
			<div class="col-xs-4 col-md-4">
				<div class="thumbnail">
					...
					<div class="caption">
						...
						<br/>
						<h4><p><span class="glyphicon glyphicon-asterisk"></span>&nbsp;&nbsp;&nbsp; 구매아이디 : ${purchase.buyer.userId}</p></h4>
						<h4><p><span class="glyphicon glyphicon-asterisk"></span>&nbsp;&nbsp;&nbsp; 구매자이름 : ${purchase.receiverName}</p></h4>
						<h4><p><span class="glyphicon glyphicon-asterisk"></span>&nbsp;&nbsp;&nbsp; 전화번호 : ${ empty purchase.receiverPhone ? "입력하지 않았습니다." : purchase.receiverPhone }</p></h4>
						...
						<h4>
							<p>
								...
								<c:if test="${tranCode == '1' }" >
									...
									<input type="hidden" id="tranNo" name="tranNo" value="${purchase.tranNo }"/>&nbsp;&nbsp;&nbsp; 배송하기 &raquo;</a>								
								</c:if>
							</p>	
						</h4>
					</div>
