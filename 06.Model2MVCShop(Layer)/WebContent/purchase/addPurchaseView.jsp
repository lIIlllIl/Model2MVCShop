...
function fncAddPurchase() {
	...
	var prodCount = ${product.prodCount };
...
function fncAddWishPurchase() {
	...
	if ( tranCount > prodCount ) {
		...
		document.addPurchase.action='/addWishPurchase.do';
		document.addPurchase.submit();
	}
}
-->
...
<input type="hidden" name="tdNo" id="tdNo" value="${product.prodCount }" />
	...
	<tr>
		...
		<td class="ct_write01">
			<input 	type="text" name="tranCount" id="tranCount" class="ct_input_g" 
							style="width: 100px; height: 19px" maxLength="20" value="${product.prodCount }" /> 개
		</td>
	</tr>
