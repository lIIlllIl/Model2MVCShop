	...
	<c:forEach var="purchase" items="${list }" >
		...
		<c:set var="tranCode" value="${fn:trim(purchase.tranCode) }" />
			<tr class="ct_list_pop">
				...
				<td></td>
				<td align="left">
						<a href="/getProduct.do?prodNo=${purchase.purchaseProd.prodNo }&menu=purchase">${purchase.purchaseProd.prodName }</a>
				</td>
				<td></td>
				...
				<td></td>
				<td align="left">
					<a href="/updateTranCode.do?tranNo=${purchase.tranNo }&tranCode=4">삭제하기</a>
				</td>
