			...
			<tr>
				<td valign="top"> 
					<table  border="0" cellspacing="0" cellpadding="0" width="159">
						...
						<tr>
							<td class="Depth03">
								<a href="/purchase/listSale" target="rightFrame">판매현황</a>
							</td>
						</tr>
						<tr>
							<td class="Depth03">
								<a href="/product/listDiscount" target="rightFrame">할인현황</a>
							</td>
						</tr>
						<tr>
							<td class="DepthEnd">&nbsp;</td>
		...
		<tr>
			<td valign="top"> 
				<table  border="0" cellspacing="0" cellpadding="0" width="159" >	
					<tr>
						<td class="Depth03">
							<a href="/getUser.do?userId=${user.userId }" target="rightFrame">회원탈퇴취소${user.userState}</a>
						</td>
					</tr>
				</table>
	</c:if>
					...
					<c:if test="${ ! empty user }" >
						<c:if test="${ user.userState != '1' }" >
							<c:if test="${ user.role == 'user' }" >
								...
								<tr>
									<td class="Depth03">
										<a href="/purchase/listWishPurchase"  target="rightFrame">장바구니</a>
									</td>
								</tr>
							</c:if>
						</c:if>
