	...
	<tr>
		...
		<td background="/images/ct_ttl_img02.gif" width="100%" style="padding-left: 10px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="93%" class="ct_ttl01">장바구니 조회</td>
				</tr>
			</table>
		</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 10px;">
	...
	<tr>
		...
		<td class="ct_line02"></td>
		<td class="ct_list_b" width="100">구매희망수량</td>
		<td class="ct_line02"></td>
		<td class="ct_list_b" width="100">현재상품수량</td>
		<td class="ct_line02"></td>
		<td class="ct_list_b" width="100">구매자이름</td>
		<td class="ct_line02"></td>
		<td class="ct_list_b" width="150">예상 결제금액</td>
		<td class="ct_line02"></td>
		<td class="ct_list_b">장바구니 삭제하기</td>
		<td class="ct_line02"></td>
	</tr>
	...
	<c:forEach var="purchase" items="${list }" >
		...
		<c:set var="tranCode" value="${fn:trim(purchase.tranCode) }" />
			<tr class="ct_list_pop">
				<td align="center">
						<a href="/purchase/getWishPurchase?tranNo=${purchase.tranNo }">${i }</a>
				</td>
				<td></td>
				<td align="left">
						<a href="/product/getProduct?prodNo=${purchase.purchaseProd.prodNo }&menu=purchase">${purchase.purchaseProd.prodName }</a>
				</td>
				<td></td>
				<td align="left">${purchase.tranCount } 개</td>
				<td></td>
				<td align="left">${purchase.purchaseProd.prodCount } 개</td>
				<td></td>
				...
				<td></td>
				<td align="left">
					<a href="/purchase/deleteWishPurchase?tranNo=${purchase.tranNo }">삭제하기</a>
				</td>
