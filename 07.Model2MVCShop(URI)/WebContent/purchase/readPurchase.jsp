			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<c:if test="${ tranCode == '5' }" >
						...
						<td background="/images/ct_btnbg02.gif" class="ct_btn01"	style="padding-top: 3px;">
							<a href="/updateWishPurchaseView.do?tranNo=${purchase.tranNo }">수정</a>
						</td>
						<td width="14" height="23">
							<img src="/images/ct_btnbg03.gif" width="14" height="23"/>
						</td>
					...
					<c:if test="${ tranCode == '5' }" >
						...
						<td background="/images/ct_btnbg02.gif" class="ct_btn01"	style="padding-top: 3px;">
							<a href="/checkPurchase.do?tranNo=${purchase.tranNo }">구매확정</a>
						</td>
						<td width="14" height="23">
							<img src="/images/ct_btnbg03.gif" width="14" height="23"/>
						</td>
					...
					<c:if test="${tranCode != '1' && tranCode != '5'  }" >
						<td width="17" height="23">
							<img src="/images/ct_btnbg01.gif" width="17" height="23"/>
						</td>
						<td background="/images/ct_btnbg02.gif" class="ct_btn01"	style="padding-top: 3px;">
							<a href="javascript:fndAlertCheck();">수정</a>
						</td>
						<td width="14" height="23">
							<img src="/images/ct_btnbg03.gif" width="14" height="23"/>
						</td>
