...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:13px;">
	...
	<tr>
		...
		<td class="ct_write01">
			<input type="text" name="prodName" value="<%=pvo.getProdName() %>" class="ct_input_g" 
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="manuDate" readonly="readonly" value="<%=pvo.getManuDate() %>" class="ct_input_g"  
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input 	type="text" name="price" value="<%=pvo.getPrice() %>" class="ct_input_g" 
							style="width:370px; height:19px"  maxLength="100">
		</td>
	</tr>
	...
	<tr>
		...
		<td class="ct_write01">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td height="26">
						<input	type="file" name="fileName" value="<%=pvo.getFileName() %>" class="ct_input_g" 
							style="width:370px; height:19px"  maxLength="100" />
					</td>
				</tr>
			</table>
