...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	...
	<%
		if(searchVO.getSearchCondition() != null ) {
			...
			svo.setSearchCondition(searchVO.getSearchCondition());
			svo.setSearchKeyword(searchVO.getSearchKeyword());
			svo.setPage(searchVO.getPage());
			svo.setPageUnit(searchVO.getPageUnit());
			
			session.setAttribute("searchVO", svo);
			
			HashMap<String,Object> m = new HashMap<String, Object>();
			m.put("count", map.get("count"));
			m.put("list", map.get("list"));
