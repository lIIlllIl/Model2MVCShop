...
<title>/product/addPurchaseView.jsp</title>
...
function fncAddPurchase() {
	var tranCount = document.addPurchase.tranCount.value;
	var prodCount = ${event.product.prodCount };

	
	if ( tranCount > prodCount ) {
		alert('판매수량이 부족합니다.');
		document.getElementById("tranCount").focus();
...
function fncAddWishPurchase() {
	...
	if ( tranCount > prodCount ) {
		...
		document.addPurchase.action='/purchase/addWishPurchase';
		document.addPurchase.submit();
	}
}
...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">${event.product.prodDetail }</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">${event.product.price }</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input 	type="text" name="tranCount" id="tranCount" class="ct_input_g" 
							style="width: 100px; height: 19px" maxLength="20" value="${event.product.prodCount }" /> 개
		</td>
	</tr>
		...
		<td align="center">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top: 3px;">
						<a href="javascript:fncAddWishPurchase();">장바구니</a>
					</td>
					<td width="14" height="23">
						<img src="/images/ct_btnbg03.gif" width="14" height="23"/>
					</td>
