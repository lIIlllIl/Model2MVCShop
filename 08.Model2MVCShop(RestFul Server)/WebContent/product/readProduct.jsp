	...
	<tr>
		...
		<td class="ct_write01">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td height="26">${event.product.price }</td>
				</tr>
			</table>
		</td>
	</tr>
					...
					<c:if test="${param.menu == 'manage' }" >
						<td width="17" height="23">
							...
							<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top:3px;">
								<a href="/product/updateProduct?prodNo=${event.product.prodNo }">수정</a>	
							</td>
					...
					<img src="/images/ct_btnbg01.gif" width="17" height="23"/>
						...
						<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top: 3px;">
							<c:choose>
								...
								<c:otherwise>
									<a href="/purchase/addPurchase?prodNo=${event.product.prodNo }">구매</a>
								</c:otherwise>
							</c:choose>
						</td>
